import unittest
from models.grocy import GrocyProductItem, GrocyStockItem, GrocyUnit  # Replace with your actual module path

class TestGrocyProductItem(unittest.TestCase):

    def test_from_json_with_html_description(self):
        data = {
            'id': 1,
            'name': 'Milk',
    ...
    def test_from_json_with_empty_description(self):
        data = {
            'id': 2,
            'name': 'Bread',
            'description': ''
